    ...
    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                ...
                <DocsPreNextBtns preName="CLI | Parser" prePath="/docs/core-component/cli-management/parser" nextName="CLI | Argument" nextPath="/docs/core-component/cli-management/argument" />
            </div>
        </DocsDrawer>
    )
}