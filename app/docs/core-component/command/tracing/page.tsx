    ...
    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                ...
                <DocsPreNextBtns preName="Command | Terminal" prePath="/docs/core-component/command/parameter" nextName="Command | configuration" nextPath="/docs/core-component/configuration/" />
            </div>
        </DocsDrawer>
    )
}