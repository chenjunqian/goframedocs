...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/error/code.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Error | Compare" prePath="/docs/core-component/error/compare" nextName="Error | Others" nextPath="/docs/core-component/error/others" />
            </div>
        </DocsDrawer>
    )
}