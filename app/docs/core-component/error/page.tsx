...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/error/overview.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Log | FAQ" prePath="/docs/core-component/log/faq" nextName="Error | Function" nextPath="/docs/core-component/error/function" />
            </div>
        </DocsDrawer>
    )
}