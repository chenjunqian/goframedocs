...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/error/stack.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Error | Function" prePath="/docs/core-component/error/function" nextName="Error | Compare" nextPath="/docs/core-component/error/compare" />
            </div>
        </DocsDrawer>
    )
}