...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/log/async.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Log | JSON Format" prePath="/docs/core-component/log/json-format" nextName="Log | Stack Print" nextPath="/docs/core-component/log/stack-print" />
            </div>
        </DocsDrawer>
    )
}