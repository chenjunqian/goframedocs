...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/log/debug-info.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Log | Stack Print" prePath="/docs/core-component/log/stack-print" nextName="Log | Writer" nextPath="/docs/core-component/log/write" />
            </div>
        </DocsDrawer>
    )
}