...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/log/faq.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Log | Rotate" prePath="/docs/core-component/log/rotate" nextName="Log | Error" nextPath="/docs/core-component/error" />
            </div>
        </DocsDrawer>
    )
}