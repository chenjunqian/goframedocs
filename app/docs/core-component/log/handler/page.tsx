...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/core-component/log/handler.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Log | Context" prePath="/docs/core-component/log/context" nextName="Log | JSON Format" nextPath="/docs/core-component/log/json-format" />
            </div>
        </DocsDrawer>
    )
}