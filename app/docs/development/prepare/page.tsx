...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/development/prepare.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Configuration" prePath="/docs/configuration" nextName="Framework Design" nextPath="/docs/framework-design" />
            </div>
        </DocsDrawer>
    )
}