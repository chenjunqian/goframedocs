    ...
    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                ...
                <DocsPreNextBtns preName="Project Package Design" prePath="/docs/framework-design/project-package-design" nextName="Project Package Design" nextPath="/docs/framework-design/project-package-design" />
            </div>
        </DocsDrawer>
    )
}