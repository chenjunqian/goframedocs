...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/framework-design/enum-management.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Context Design" prePath="/docs/framework-design/context-design" />
            </div>
        </DocsDrawer>
    )
}