...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/framework-design/module-design.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Example" prePath="/docs/example" nextName="Unified framework design" nextPath="/docs/framework-design/unified-framework-design" />
            </div>
        </DocsDrawer>
    )
}