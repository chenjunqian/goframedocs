...
export default async function Page() {
    ...
    const installationMD = await fs.readFile(process.cwd() + "/docs/framework-design/tracing-design.md", "utf-8");

    return (
        <DocsDrawer>
            <div className="w-full pl-16 pr-16 mt-9">
                <DocsMarkdownViewer children={installationMD} />
                <DocsPreNextBtns preName="Microservice" prePath="/docs/framework-design/microservice" nextName="Error Design" nextPath="/docs/framework-design/error-design" />
            </div>
        </DocsDrawer>
    )
}