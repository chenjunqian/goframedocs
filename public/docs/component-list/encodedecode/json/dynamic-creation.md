...
`gjson` is not only capable of flexibly parsing and retrieving unknown data structures, but it can also dynamically create and modify the content of data structures.
