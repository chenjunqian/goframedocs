...
There is also an advanced usage where the client can define a custom `TraceID` using the `gtrace.WithTraceID` method. The method is defined as follows:
